<template>
  <div class="public-account-management clearfix" style="margin-bottom: 80px;">
    <!--左边配置菜单-->
    <div class="left">
      <div class="menu clearfix">
        ...
        <!-- 一级菜单加号 -->
        <div v-if="menuKeyLength < 3" class="menu_bottom menu_addicon" @click="addMenu"><i class="el-icon-plus" />
        </div>
      </div>
...
/**
   ...
   *  的其他内容也填写了，也不妨碍。
   */
import { getMenu, addMenu } from '@/api/wechat'
export default {
  name: 'WechatMenu',
  components: {},
  filters: {},
  ...
  methods: {
    ...
    mockMenuFun() {
      getMenu().then(res => {
        this.menu.button = res.data.menu.button
      })
    },
    // 素材内容弹框的选择按钮函数
    ...
    saveFun() {
      this.$confirm('此操作将更新微信菜单，是否继续?', '提示', {
...
<style lang="less" scoped="scoped">
  ...
  .public-account-management {
    ...
    .left {
      ...
      width: 350px;
      height: 715px;
      background: url("../../assets/components_img/iphone_backImg.png") no-repeat;
